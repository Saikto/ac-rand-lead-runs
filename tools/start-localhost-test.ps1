...
if (9600 -in $tcpPorts -or 9600 -in $udpPorts -or 8081 -in $tcpPorts) {
    throw 'Port 9600 or 8081 is already in use. Stop the previous localhost server and retry.'
}
...
Write-Output 'Connect in Content Manager to 127.0.0.1:9600.'
